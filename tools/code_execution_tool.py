...
def execute_code(
    ...
    if not _guard.get("approved", False):
        ...
        if _guard.get("user_summary"):
            _blocked_body["user_summary"] = _guard["user_summary"]  # upstream: one human sentence
        return json.dumps(_blocked_body, ensure_ascii=False)
