...
TOOLSETS = {
    ...
    # fork: narrow send_message toolset — only the WeCom platform bundles below
    # include it, so the agent can message a WeCom user but nothing else.
    "send_message": _ts("Send a message to a connected platform user/channel (narrow: WeCom toolsets)", ["send_message"]),
